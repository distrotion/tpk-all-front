...
class _P303QMMASTERQCMAINState extends State<P303QMMASTERQCMAIN> {
  ...
  Widget build(BuildContext context) {
    ...
    //   }
    // }
    if (P303QMMASTERQCVAR.FILTER == 'ALL') {
      _datasearch = _datain;
    } else {
      // _datasearch = _datain;
    ...
    for (int i = 0; i < _datasearch.length; i++) {
      if (_datasearch[i].PROCESS_ORDER.contains(P303QMMASTERQCVAR.SEARCH) ||
          _datasearch[i].MATERIAL.contains(P303QMMASTERQCVAR.SEARCH) ||
          _datasearch[i].MAT_DESC.contains(P303QMMASTERQCVAR.SEARCH) ||
          _datasearch[i].OLD_MAT.contains(P303QMMASTERQCVAR.SEARCH) ||
          _datasearch[i].BATCH.contains(P303QMMASTERQCVAR.SEARCH)) {
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: AdvanceDropDown(
                                ...
                                onChangeinside: (d, k) {
                                  setState(() {
                                    P303QMMASTERQCVAR.FILTER = d;
                                  });
                                },
                                value: P303QMMASTERQCVAR.FILTER,
                                height: 40,
                                width: 100,
                              ),
                            ),
