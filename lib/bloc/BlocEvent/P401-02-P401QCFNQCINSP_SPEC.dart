...
import '../../page/P401QCFN/P401QCFNQCVAR.dart';
import '../../widget/common/Loading.dart';
//-------------------------------------------------

abstract class P401QCFNgetINSP_SPEC_Event {}

class P401QCFNgetINSP_SPEC_GET extends P401QCFNgetINSP_SPEC_Event {}

class P401QCFNgetINSP_SPEC_GET2 extends P401QCFNgetINSP_SPEC_Event {}

class P401QCFNgetINSP_SPEC_GET3 extends P401QCFNgetINSP_SPEC_Event {}

class P401QCFNgetINSP_SPEC_FLUSH extends P401QCFNgetINSP_SPEC_Event {}

class P401QCFNgetINSP_SPEC_Bloc
    extends Bloc<P401QCFNgetINSP_SPEC_Event, P401QCFNgetINSP_SPECclassSET> {
  P401QCFNgetINSP_SPEC_Bloc() : super(P401QCFNgetINSP_SPECclassSET()) {
    on<P401QCFNgetINSP_SPEC_GET>((event, emit) {
      return _P401QCFNgetINSP_SPEC_GET(P401QCFNgetINSP_SPECclassSET(), emit);
    });

    on<P401QCFNgetINSP_SPEC_GET2>((event, emit) {
      return _P401QCFNgetINSP_SPEC_GET2(P401QCFNgetINSP_SPECclassSET(), emit);
    });
    on<P401QCFNgetINSP_SPEC_GET3>((event, emit) {
      return _P401QCFNgetINSP_SPEC_GET3(P401QCFNgetINSP_SPECclassSET(), emit);
    });
    on<P401QCFNgetINSP_SPEC_FLUSH>((event, emit) {
      return _P401QCFNgetINSP_SPEC_FLUSH(P401QCFNgetINSP_SPECclassSET(), emit);
    });
  }

  Future<void> _P401QCFNgetINSP_SPEC_GET(P401QCFNgetINSP_SPECclassSET toAdd,
      Emitter<P401QCFNgetINSP_SPECclassSET> emit) async {
    // FreeLoadingTan(CONTEXTFORUSEPAGE19TO25.LOADINGcontext);
    P401QCFNgetINSP_SPECclassSET output = P401QCFNgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
    final response = await Dio().post(
      ...
      data: {
        "HEADER": {
          "FROM_DATE":
              "${P401QCFNVAR.day}.${P401QCFNVAR.month}.${P401QCFNVAR.year}",
          "TO_DATE":
              "${P401QCFNVAR.day_next}.${P401QCFNVAR.month_next}.${P401QCFNVAR.year_next}",
          "PLANT": P401QCFNVAR.PLANT,
          // "LOT_ORI": P401QCFNVAR.LOT_ORI,
          "LOT_ORI": "03",
          "MATERIAL": "",
          "BATCH": "",
          "LOT_NO": ""
...
//INSP_LOT
  ...
  Future<void> _P401QCFNgetINSP_SPEC_GET2(P401QCFNgetINSP_SPECclassSET toAdd,
      Emitter<P401QCFNgetINSP_SPECclassSET> emit) async {
    P401QCFNgetINSP_SPECclassSET output = P401QCFNgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
    P401QCFNgetINSP_SPECclassSET datadummy = P401QCFNgetINSP_SPECclassSET();
  ...
  Future<void> _P401QCFNgetINSP_SPEC_GET3(P401QCFNgetINSP_SPECclassSET toAdd,
      Emitter<P401QCFNgetINSP_SPECclassSET> emit) async {
    P401QCFNgetINSP_SPECclassSET output = P401QCFNgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
    P401QCFNgetINSP_SPECclassSET datadummy = P401QCFNgetINSP_SPECclassSET();
  ...
  Future<void> _P401QCFNgetINSP_SPEC_FLUSH(P401QCFNgetINSP_SPECclassSET toAdd,
      Emitter<P401QCFNgetINSP_SPECclassSET> emit) async {
    P401QCFNgetINSP_SPECclassSET output = P401QCFNgetINSP_SPECclassSET();
    emit(output);
  }
...
class P401QCFNgetINSP_SPECclassSET {
