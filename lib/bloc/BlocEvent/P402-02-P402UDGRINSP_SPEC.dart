...
abstract class P402UDGRgetINSP_SPEC_Event {}

class P402UDGRgetINSP_SPEC_GET extends P402UDGRgetINSP_SPEC_Event {}

class P402UDGRgetINSP_SPEC_GET2 extends P402UDGRgetINSP_SPEC_Event {}

class P402UDGRgetINSP_SPEC_GET3 extends P402UDGRgetINSP_SPEC_Event {}

class P402UDGRgetINSP_SPEC_FLUSH extends P402UDGRgetINSP_SPEC_Event {}

class P402UDGRgetINSP_SPEC_Bloc
    extends Bloc<P402UDGRgetINSP_SPEC_Event, P402UDGRgetINSP_SPECclassSET> {
  P402UDGRgetINSP_SPEC_Bloc() : super(P402UDGRgetINSP_SPECclassSET()) {
    on<P402UDGRgetINSP_SPEC_GET>((event, emit) {
      return _P402UDGRgetINSP_SPEC_GET(P402UDGRgetINSP_SPECclassSET(), emit);
    });

    on<P402UDGRgetINSP_SPEC_GET2>((event, emit) {
      return _P402UDGRgetINSP_SPEC_GET2(P402UDGRgetINSP_SPECclassSET(), emit);
    });
    on<P402UDGRgetINSP_SPEC_GET3>((event, emit) {
      return _P402UDGRgetINSP_SPEC_GET3(P402UDGRgetINSP_SPECclassSET(), emit);
    });
    on<P402UDGRgetINSP_SPEC_FLUSH>((event, emit) {
      return _P402UDGRgetINSP_SPEC_FLUSH(P402UDGRgetINSP_SPECclassSET(), emit);
    });
  }

  Future<void> _P402UDGRgetINSP_SPEC_GET(P402UDGRgetINSP_SPECclassSET toAdd,
      Emitter<P402UDGRgetINSP_SPECclassSET> emit) async {
    // FreeLoadingTan(CONTEXTFORUSEPAGE19TO25.LOADINGcontext);
    P402UDGRgetINSP_SPECclassSET output = P402UDGRgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
...
//INSP_LOT
  ...
  Future<void> _P402UDGRgetINSP_SPEC_GET2(P402UDGRgetINSP_SPECclassSET toAdd,
      Emitter<P402UDGRgetINSP_SPECclassSET> emit) async {
    P402UDGRgetINSP_SPECclassSET output = P402UDGRgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
    P402UDGRgetINSP_SPECclassSET datadummy = P402UDGRgetINSP_SPECclassSET();
  ...
  Future<void> _P402UDGRgetINSP_SPEC_GET3(P402UDGRgetINSP_SPECclassSET toAdd,
      Emitter<P402UDGRgetINSP_SPECclassSET> emit) async {
    P402UDGRgetINSP_SPECclassSET output = P402UDGRgetINSP_SPECclassSET();
    //-------------------------------------------------------------------------------------
    P402UDGRgetINSP_SPECclassSET datadummy = P402UDGRgetINSP_SPECclassSET();
  ...
  Future<void> _P402UDGRgetINSP_SPEC_FLUSH(P402UDGRgetINSP_SPECclassSET toAdd,
      Emitter<P402UDGRgetINSP_SPECclassSET> emit) async {
    P402UDGRgetINSP_SPECclassSET output = P402UDGRgetINSP_SPECclassSET();
    emit(output);
  }
...
class P402UDGRgetINSP_SPECclassSET {
