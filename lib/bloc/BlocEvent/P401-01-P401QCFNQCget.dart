...
import '../../page/P401QCFN/P401QCFNMAIN.dart';

import '../../page/P401QCFN/P401QCFNQCVAR.dart';
import '../../widget/common/Loading.dart';
//-------------------------------------------------

abstract class P401QCFNget_Event {}

class P401QCFNget_GET extends P401QCFNget_Event {}

class P401QCFNget_GET2 extends P401QCFNget_Event {}

class P401QCFNget_GET3 extends P401QCFNget_Event {}

class P401QCFNget_FLUSH extends P401QCFNget_Event {}

class P401QCFNget_Bloc extends Bloc<P401QCFNget_Event, List<P401QCFNgetclass>> {
  P401QCFNget_Bloc() : super([]) {
    on<P401QCFNget_GET>((event, emit) {
      return _P401QCFNget_GET([], emit);
    });

    on<P401QCFNget_GET2>((event, emit) {
      return _P401QCFNget_GET2([], emit);
    });
    on<P401QCFNget_GET3>((event, emit) {
      return _P401QCFNget_GET3([], emit);
    });
    on<P401QCFNget_FLUSH>((event, emit) {
      return _P401QCFNget_FLUSH([], emit);
    });
  }

  Future<void> _P401QCFNget_GET(List<P401QCFNgetclass> toAdd,
      Emitter<List<P401QCFNgetclass>> emit) async {
    // FreeLoadingTan(CONTEXTFORUSEPAGE19TO25.LOADINGcontext);
    FreeLoading(P401QCFNMAINcontext);
    List<P401QCFNgetclass> output = [];
    //-------------------------------------------------------------------------------------
...
//INSP_LOT
    ...
    Navigator.pop(P401QCFNMAINcontext);
    emit(output);
  }

  Future<void> _P401QCFNget_GET2(List<P401QCFNgetclass> toAdd,
      Emitter<List<P401QCFNgetclass>> emit) async {
    List<P401QCFNgetclass> output = [];
    //-------------------------------------------------------------------------------------
    List<P401QCFNgetclass> datadummy = [];
  ...
  Future<void> _P401QCFNget_GET3(List<P401QCFNgetclass> toAdd,
      Emitter<List<P401QCFNgetclass>> emit) async {
    List<P401QCFNgetclass> output = [];
    //-------------------------------------------------------------------------------------
    List<P401QCFNgetclass> datadummy = [];
  ...
  Future<void> _P401QCFNget_FLUSH(List<P401QCFNgetclass> toAdd,
      Emitter<List<P401QCFNgetclass>> emit) async {
    List<P401QCFNgetclass> output = [];
    emit(output);
  }
